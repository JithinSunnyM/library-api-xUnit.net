...
namespace LibraryAPI.Test
{
    public class BooksControllerTest
    {
        ...
        public void GetBookByIdTest(string guidOne, string guidTwo)
        {
            //arrange
            var validGuid = new Guid(guidOne);
            var invalidGuid = new Guid(guidTwo);
            //act
        ...
        [Theory]
        [InlineData("ab2bd817-98cd-4cf3-a80a-53ea0cd9c200", "ab2bd817-98cd-4cf3-a80a-53ea0cd9c111")]
        public void RemoveBookByIdTest(string guidOne, string guidTwo)
        {
            //arrange
            var validGuid = new Guid(guidOne);
            var invalidGuid = new Guid(guidTwo);
